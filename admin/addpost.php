...
<div class="grid_10">
    ...
    <div class="box round first grid">
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($post_title == "" || $category_id == "" || $post_body == "" || $file_name == "" || $post_author == "" || $post_tags == "" || $tags_description=="") {
                ...
                $query = "INSERT INTO  tbl_post(category_id,post_title,post_body,post_image,post_author,post_tags,tags_description,user_id) VALUES('$category_id','$post_title','$post_body','$folder','$post_author','$post_tags','$tags_description','$user_id')";
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <table class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="post_author" value="<?php echo $user_name ?>"  class="medium" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="tags_description"  placeholder="Enter Tags Description Title..." class="medium" />
                        </td>
                    </tr>
                    <tr>
                        <td></td>
